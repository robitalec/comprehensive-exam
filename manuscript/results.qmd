...
<!-- - Variance strategies -->
<!-- 	- Risk-averse foragers favor minimizing variance and should prefer scrounging  -->
<!-- 	- Risk-tolerant foragers should prefer producing -->
...
- Patch distribution
	...
	- If patches are distributed in rich, clumps, scrounging should increase and if patches are evently distributed, producing should increase (Dubois_2020) (Ohtsuka_2009)
