...
## (Introduction) How do individual's behaviours affect access to resources? Why is access to resources important?
...
## (Social foraging) Why is it important to consider presence and density of conspecifics? What approaches can be used to model interdependence of individiuals?
<!-- 

Point to box

Emphasis on relevant features of social foraging theory for the question
Introduce 
- roles
...
##### Approaches
<!-- Review approaches and counts from literature Supplemental Table N--> 
...
### (Gaps from social foraging theory) What assumptions of social foraging models might lead to missed inference about the relationship between animals, their conspecifics and their habitats?
