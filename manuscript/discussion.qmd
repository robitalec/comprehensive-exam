...
So that social foraging can be integrated with resources, risks and conditions
...
can issa tell us about behaviour eg. like hmm
...
- par 2, add more interpretation
- add par to contrasting approaaches
- content > writing
- make sure big ideas are there
...
- check always prop scrounging

- relationships directly linked to proportion of scrounging are discussed, tangentially eg. group size related to predation risk, are not considered
