...
digraph habitat_and_producer {
  ...
  rankdir = TB
	...
	Habitat [label = "Habitat\nselection", color = "#959D71"]
	Resources [color = "#959D71"]
	Conditions [color = "#959D71"]
	Risks [color = "#959D71"]

    Roles [color = "#9d7195"]
	access_avail [label = "Availability\nand\naccess", shape = ellipse, color = "#AD8F89"]
	ps_dyn [label = "Producer-scrounger\ndynamics", color = "#9d7195"]
	freq [label = "Frequency\ndependence", color = "#9d7195"]
	patch_penalties [label = "Patch penalties", color = "#9d7195"]
	patch_payoffs [label = "Patch payoffs", color = "#9d7195"]
...
digraph habitat_and_producer {
  bgcolor = transparent;
  rankdir = TB
	node [fontsize = 36, shape = box, fontname = Helvetica, fontcolor = "#9d9d9d", style = filled, color = "#325861", fillcolor = "#325861", penwidth = 4]
	edge [penwidth = 3, color = "#122124"] 
	Habitat [label = "Habitat\nselection"]
	Resources
	Conditions
	Risks

    Roles [color = "#9d7195", fontcolor = "#e1e1e1", fillcolor = "#3f6f7a"]
	ps_dyn [label = "Producer-scrounger\ndynamics", color = "#9d7195", fillcolor = "#3f6f7a", fontcolor = "#e1e1e1"]
	freq [label = "Frequency\ndependence"]
