...
::: {.notes}
Resources are environmental variables that a positive expected effect on fitness
...
::: {.notes}
Risks are environmental variables that a negative expected effect on fitness
...
::: {.notes}
Conditions are interesting in their expected effect on fitness is bell shaped where when conditions are "regular" or "average" they have a neutral or positive expected effect
